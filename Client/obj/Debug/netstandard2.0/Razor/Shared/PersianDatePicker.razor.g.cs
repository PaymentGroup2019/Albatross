#pragma checksum "E:\Blazor\Albatross\Albatross\Client\Shared\PersianDatePicker.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b09764d2ef8eae774b30214dd2c67c33193ab28b"
// <auto-generated/>
...
#line hidden
    ...
    public class PersianDatePicker : Microsoft.AspNetCore.Components.ComponentBase
    {
        #pragma warning disable 1998
        protected override void BuildRenderTree(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder __builder)
        {
            __builder.AddMarkupContent(0, @"<div class=""input-group"">
    <div class=""input-group-prepend"">
        <span class=""input-group-text cursor-pointer"" id=""persian-date""></span>
    </div>
    <input type=""text"" id=""input-persian-date"" class=""form-control"" placeholder aria-label=""persian-date"" aria-describedby=""persian-date"">
</div>");
        }
        #pragma warning restore 1998
#line 15 "E:\Blazor\Albatross\Albatross\Client\Shared\PersianDatePicker.razor"
       
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            await JsRuntime.InvokeVoidAsync("datepicker.initiate");
        }
    }
