window.pageInitialization = {
    ...
    initiate: function () {
        ...
        $(document).ready(function () {
            ...
            function initLogin() {
                $("#input100-username").focus(() => { $("#input100-username").addClass("text-center"); })
                $("#input100-username").blur(() => { $("#input100-username").removeClass("text-center"); })
                $("#input100-password").focus(() => { $("#input100-password").addClass("text-center"); })
                $("#input100-password").blur(() => { $("#input100-password").removeClass("text-center"); })
            };
